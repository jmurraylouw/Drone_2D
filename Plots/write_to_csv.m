...
%% HAVOK
load('Plots/MPC_havok_vs_pid_1.mat');
...
%% DMD
load('Plots/MPC_dmd_vs_pid_1.mat');
...
pos_step_pid = array2table([t', X_pid, T_pid, X_havok, T_havok, X_dmd, T_dmd]);

pos_step_pid.Properties.VariableNames = { ...
    't', ...
    
    'x_pid', 'z_pid', 'th_pid', 'b_pid', ...
    'dx_pid', 'dz_pid', 'dth_pid', 'db_pid', ...
    'T1_pid', 'T2_pid', ...
    
    'x_havok', 'z_havok', 'th_havok', 'b_havok', ...
    'dx_havok', 'dz_havok', 'dth_havok', 'db_havok', ...
    'T1_havok', 'T2_havok', ...
    
    'x_dmd', 'z_dmd', 'th_dmd', 'b_dmd', ...
    'dx_dmd', 'dz_dmd', 'dth_dmd', 'db_dmd', ...
    'T1_dmd', 'T2_dmd' ...
